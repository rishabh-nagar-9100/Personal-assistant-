...
public class DsaQuestion {
    ...
    protected DsaQuestion() {
        // JPA requires no-arg constructor
    }

    public DsaQuestion(User user, String title, String topic, DsaDifficulty difficulty, String sourceLink, DsaStatus status) {
        this.user = user;
        this.title = title;
        this.topic = topic;
        this.difficulty = difficulty != null ? difficulty : DsaDifficulty.MEDIUM;
        this.sourceLink = sourceLink;
        this.status = status != null ? status : DsaStatus.NOT_STARTED;
    }
